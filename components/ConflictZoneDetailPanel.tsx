      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center pointer-events-none">
        <div className="pointer-events-auto max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded border border-[#d4b36a]/30 bg-[#07120d] shadow-2xl">
          <div className="sticky top-0 flex items-center justify-between border-b border-[#d4b36a]/30 bg-[#08120d] px-6 py-4">
            ...
            <button onClick={onClose} className="rounded p-2 text-slate-400 transition hover:bg-[#163025] hover:text-[#d4b36a]">
              <X size={20} />
            </button>
          </div>

          <div className="space-y-6 p-6">
            <div className="grid grid-cols-2 gap-4 border-b border-[#23503a] pb-4 sm:grid-cols-3">
              <div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {zone.sources.map((source, idx) => (
                  <span key={idx} className="rounded border border-[#23503a] bg-[#0a1711] px-2 py-1 text-xs text-slate-400">
                    {source}
                  </span>
                ))}
              </div>
